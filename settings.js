...
global.owner = process.env.OWNER_NUMBER  || 923287621448' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=rEVwmYiL#nz82M3-BBmAZZfcT3wv5ivfvyGvY21E6CEkJCIrqnbE' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,94787820101" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || '♥*Post By*
✤͜˚₊· ͟͟͞͞➳❥𝐅𝐚𝐡𝐞𝐞𝐦 𝐇𝐚𝐜𝐤𝐞𝐫⁵⁶😉✧•' ,
